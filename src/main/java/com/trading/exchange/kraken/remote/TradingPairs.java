...
public enum TradingPairs {
	...
	double feesm;
	double feest;
private TradingPairs(double min,double feesm,double feest){this.min=min;this.feesm=feesm;this.feest=feest;}
...
public static void main (String args[]){
	int i=0;
	while(i<TradingPairs.values().length){
	TradingPairs a=TradingPairs.values()[i];
